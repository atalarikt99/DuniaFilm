...
public class NowFragment extends Fragment {
    ...
    {
        String url = "https://api.themoviedb.org/3/movie/now_playing?api_key=16987bda6bafa13652962e190e3646bf";

        GsonGetRequest<SourcesResponse> myRequest = new GsonGetRequest<SourcesResponse> (url, SourcesResponse.class, null, new Response.Listener<SourcesResponse>()
        {
            @Override
